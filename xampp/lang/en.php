<?php
	...
	$TEXT['security-pop-text'] = "Please check and perhaps edit all users and passwords in the the Mercury Mail server confaguration!";
	...
	$TEXT['cds-text2'] = "CD list as <a href='cds.php?action=getpdf'>PDF document</a>.";
